...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //Associando as permissões ao Papel
        foreach($request->permissions as $key => $permission){

            $permissao = Permission::where('name', $key )->first();

            $registro->permissions()->attach($permissao);
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('roles_permissions')->where('role_id', $registro->id)->delete();
