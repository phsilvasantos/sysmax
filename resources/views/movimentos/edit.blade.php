...
@section('content')
    ...
    <form action="{{route('movimentos.update', $registro->id)}}" method="post" name="form1">
                        ...
                        <div class="col">
                            ...
                            <select class="form-control form-control-sm" name="conta_id">
                                @foreach(\App\Models\Contas\Conta::all() as $conta)
                                    <option value="{{$conta->id}}" @if($registro->conta_id == $conta->id) selected @endif> {{$conta->nome}} - {{$conta->conta}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Data</label>
                                <input type="date" class="form-control form-control-sm" name="data"  value="{{$registro->data}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="historico"  required   value="{{$registro->historico}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="documento"  required   value="{{$registro->documento}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Valor</label>
                                <input type="text" class="form-control form-control-sm" name="valor"  required   value="{{$registro->valor}}">
                            </div>
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{route('movimentos.destroy', $registro->id)}}" class="btn btn-danger" onclick="event.preventDefault();
                                                     document.getElementById('delete-form').submit();">Desativar</a>

                    <form id="delete-form" action="{{ route('movimentos.destroy', $registro->id) }}" method="POST" style="display: none;">
                        @csrf
