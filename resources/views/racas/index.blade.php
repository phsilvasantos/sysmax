    ...
    <div class="col-md-12">
        <div class="card Recent-Users">
            <div class="card-header">
                <h5>Listagem de Raças</h5>
                <div class="card-header-right">
                    <a href="{{route('racas.create')}}" class="btn btn-rounded btn-sm btn-primary text-white ">NOVO</a>
                </div>
            </div>
                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($registros as $registro)
                            ...
                            <td style="text-align:right;">
                                ...
                                <a href="{{route('racas.edit', $registro->id)}}" class="label theme-bg text-white f-12"  style="margin-right:20px;">Acessar</a>
