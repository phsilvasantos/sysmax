    ...
    <div class="col-md-12">
        <div class="card Recent-Users">
            <div class="card-header">
                <h5>Listagem das contas</h5>
                <div class="card-header-right">
                    <a href="{{route('contas.create')}}" class="btn btn-rounded btn-sm btn-primary text-white ">NOVO</a>
                </div>
            </div>
                    ...
                    <table class="table table-hover  table-list" id="myTable5">
                        ...
                        @foreach($registros as $registro)
                            ...
                            <td style="text-align:right;">
                                ...
                                <a href="{{route('contas.edit', $registro->id)}}" class="label theme-bg text-white f-12"  style="margin-right:20px;">Acessar</a>
