...
@section('content')
    ...
    <form action="{{route('setores.update', $registro->id)}}" method="post" name="form1">
                ...
                <div class="card-block p-0">
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col text-right">
                            <a href="{{route('setores.index')}}"> <button type="button" class="btn btn-sm btn-default btn-shadow-1 btn-rounded"><i class="feather icon-arrow-left"></i>Voltar</button></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="{{route('setores.destroy', $registro->id)}}" class="btn btn-danger" onclick="event.preventDefault();
                                                     document.getElementById('delete-form').submit();">Desativar</a>

                    <form id="delete-form" action="{{ route('setores.destroy', $registro->id) }}" method="POST" style="display: none;">
                        @csrf
